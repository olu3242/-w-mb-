// ─── components/owambe/AsoEbiScene.tsx ──────────────────────
// "use client";
...
//     color: "#065F46",
//     status: "Delivered",
//     statusBg: "bg-[#065F46]/10 text-[#065F46]",
//   },
//   {
//     initials: "OO",
//     name: "Ola Otunba",
...
//     statusBg: "bg-[#FACC15]/30 text-[#1A1A1A]",
//   },
//   {
//     initials: "BS",
//     name: "Bode Smith",
...
//       id="scenes"
//       ref={ref}
//       className="relative min-h-[80vh] flex items-center px-6 md:px-12 bg-[#1A1A1A] border-y border-[#1A1A1A] overflow-hidden"
//     >
//       <img
...
//         >
//           <span className="text-xs font-black uppercase tracking-widest text-[#FACC15] mb-4 block">
//             01 / The Uniform
//           </span>
//           <h2
//             className="font-black uppercase text-6xl md:text-8xl leading-none mb-8"
//             style={{ lineHeight: 0.85, letterSpacing: "-0.04em" }}
//           >
//             Aso-Ebi <br /> Sync.
//           </h2>
//           <p className="text-xl font-bold opacity-80">
//             Coordinate your matching fabrics without the chaos. Track payments,
//             delivery, and tailoring sizes for 50 or 500 friends.
//           </p>
//         </motion.div>

//         <motion.div
//           className="w-full max-w-md text-[#1A1A1A]"
//           style={{
...
//                 <div
//                   key={i}
//                   className="flex justify-between items-center p-3 border-b border-[#1A1A1A]/5 last:border-0"
//                 >
...
//                   </div>
//                   <span
//                     className={`text-[10px] font-black uppercase px-2 py-1 ${p.statusBg}`}
//                   >
//                     {p.status}
//                   </span>
//                 </div>
//               ))}
//             </div>
//             <button className="w-full mt-8 bg-[#1A1A1A] text-white py-4 font-black uppercase text-xs tracking-widest hover:bg-[#065F46] transition-colors">
