...
//                     <h4 className="text-3xl font-bold text-green-400">₦4.2M</h4>
    ...
    <section className="relative min-h-screen flex items-center px-6 pt-40 pb-20 md:px-12 overflow-hidden bg-[#0a0a0a] font-poppins">
      ...
      <div className="absolute inset-0 z-0">
        <video
          ...
          src="/herovideo.mp4"
          // Poster shows while video loads — swap for any fallback image
          poster="https://images.unsplash.com/photo-1511795409834-ef04bbd61622?auto=format&fit=crop&q=80&w=1600"
        />
      ...
      <div className="container mx-auto relative z-10 grid lg:grid-cols-12 gap-12 items-center">
        ...
        <div className="lg:col-span-8">
          <motion.div {...fadeInUp}>
            ...
            <p className="text-lg md:text-xl font-medium text-white max-w-xl leading-relaxed mb-12">
              Nigerian celebrations are a force of nature. We provide the
              architectural precision to manage the chaos, so you can focus on
              the soul of the event.
            </p>
            ...
            <div className="flex flex-wrap gap-6">
              ...
              <button className="group relative flex items-center gap-3 text-white px-10 py-5 rounded-full font-black uppercase text-xs tracking-widest transition-all overflow-hidden hover:shadow-lg hover:shadow-green-900/40">
                <Image
                  src="/ankar.png"
                  alt=""
                  fill
        ...
        <div className="lg:col-span-4 hidden lg:block">
          ...
          >
            ...
            <div
              className="relative backdrop-blur-3xl border border-white/10 p-8 rounded-3xl overflow-hidden"
              style={{
                ...
                <div className="space-y-8">
                  <div className="flex items-end justify-between">
                    <div>
                      ...
                      <p className="text-[10px] font-bold uppercase text-zinc-200 flex items-center gap-2 mt-2">
                        <Users size={12} className="text-green-400" /> Guests In
                      </p>
                    </div>
                    <div className="text-right">
                      ...
                      <p className="text-[10px] font-bold uppercase text-zinc-200 flex items-center gap-2 justify-end mt-2">
                        <Wallet size={12} className="text-green-400" /> Sprayed
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-2 gap-4 pt-4">
                    <div className="p-4 rounded-2xl bg-white/10 border border-white/10">
                      <p className="text-lg font-bold text-white">12</p>
                      <p className="text-[8px] font-black uppercase text-zinc-200">
                        Vendors
                      </p>
                    </div>
                    <div className="p-4 rounded-2xl bg-white/10 border border-white/10">
